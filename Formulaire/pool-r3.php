...
$subject = 'Nouvelle prédiction - Ronde 3 du pool';

$body  = "Nouvelle prédiction reçue - RONDE 3\n\n";
...
@file_put_contents(__DIR__ . '/pool-r3-submissions.csv', implode(';', $csv_line) . PHP_EOL, FILE_APPEND);

if ($ok) {
  echo json_encode(['ok' => true]);
} else {
  error_log('mail() a renvoyé false dans pool-r3.php');
